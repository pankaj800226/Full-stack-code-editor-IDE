...
const Templte1 = () => {
  ...
  // 🧩 Handle project title/summary change
  ...
  const addField = (field: "skills" | "projects") => {
    if (field === "skills") {
      ...
      setFormData({
        ...formData,
        projects: [...formData.projects, { title: "", summary: "" }],
      });
    }
  };
        ...
        <div className="resume_right_side">
          ...
          <div className="input-group">
            ...
            <input
              ...
              onChange={handleChange}
              placeholder="Add 10th/ Secondary School"
            />
          </div>
          ...
          <div className="input-group">
            ...
            <input
              type="text"
              name="matrixDetails"
              value={formData.matrixDetails}
              onChange={handleChange}
              placeholder="Add 12th / Intermediate"
            />
          </div>
          ...
          <div className="input-group">
            ...
            <input
              type="text"
              name="graducationDetails"
              value={formData.graducationDetails}
              onChange={handleChange}
              placeholder="Add Graduation Details"
            />
          </div>
          ...
          {formData.projects.map((p, index) => (
            <div className="array-input" key={index}>
              ...
              <input
                ...
                value={p.summary}
                onChange={(e) => handleProjectChange(e, index, "summary")}
              />
        ...
        <div className="resume_left_side">
          <div className="resume_card" ref={resumeRef}>
            ...
            {formData.projects.map((p, i) => (
              <div key={i}>
                <h3 style={{color:"#222"}}>{p.title || "Project Title"}</h3>
                <p>{p.summary}</p>
              </div>
            ))}
          </div>
